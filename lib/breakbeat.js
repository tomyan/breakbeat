...
ast.Subtraction = function () {
    arguments.callee.base.apply(this, arguments);
    this.type = 'subtraction';
};

extend(ast.Subtraction, binaryOperation);

ast.Concatenation = function () {
    arguments.callee.base.apply(this, arguments);
    this.type = 'concatenation';
};

extend(ast.Concatenation, binaryOperation);
...
var binaryOperators = { 
    ...
    '-' : {
        ...
        'precedence'    : 2,
        'associativity' : 'left',
        'astType'       : ast.Subtraction
    },
    '.' : {
        'op'            : '.',
        'precedence'    : 2,
        'associativity' : 'left',
        'astType'       : ast.Concatenation
    },
    '*' : {
        'op'            : '*',
        'precedence'    : 1,
